...
(function () {
  ...
  // Contact form — validate, screen for spam (honeypot), deliver via form backend
  var form = document.querySelector("#contactForm");
  if (form) {
    // Success/error banners sit just outside the <form>, in the surrounding card.
    ...
    // Clear a field's invalid state as the user corrects it
    ...
    form.addEventListener("submit", function (e) {
      ...
      // Honeypot — bots fill this hidden field. Feign success and drop the submission.
      ...
      // Validate required fields (name, valid email, message)
      ...
      if (firstBad) {
        showError("Please fill in your name, a valid email, and a message.");
        firstBad.focus();
        return;
      }

      // Deliver to the configured form backend
