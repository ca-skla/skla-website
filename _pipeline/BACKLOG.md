...
## State
```
last_run: 2026-09-05 (draft lane, dry-run: Q-00 reactive Update)
last_scanned: 2026-09-05
next_audience: business        # rotation: nri -> investor -> business -> nri; unchanged — the 5 Sep run took the reactive item Q-00, not a rotation slot
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | Q-00 | The Foreign Assets of Small Taxpayers Disclosure Scheme, 2026: who can use the window before 31 December 2026 | nri newact | Update | A | reactive: Finance Act 2026 Ch. IV; Rules G.S.R. 732(E), 14 Aug 2026 (FACTS F-0201, F-0204–F-0219) | nri | 900–1,400 | 2026-09-20 | — | yes | in-review (dry-run branch `dryrun/foreign-assets-disclosure-scheme-2026`; no PR — mode dry-run) | — | drafted 2026-09-05; slug insights-foreign-assets-disclosure-scheme-2026.html; review pack _pipeline/reviews/foreign-assets-disclosure-scheme-2026.md |
